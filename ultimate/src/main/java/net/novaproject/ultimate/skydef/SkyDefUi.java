...
public class SkyDefUi extends CustomInventory {
    ...
    public void setup() {
        ...
        addMenu(0, new ItemCreator(Material.PRISMARINE_SHARD)
                        .setName(LangManager.get().get(CoreLang.COMMON_CLICK_HERE_TO_MODIFY, getPlayer())),
        ...
        addMenu(13, defTeamSize, new ConfigVarUi(getPlayer(), 3, 2, 1, 3, 2, 1, sky.getTeam_size(), 2, Double.NaN, this) {
            @Override
