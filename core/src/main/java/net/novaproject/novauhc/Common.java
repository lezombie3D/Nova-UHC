...
public class Common {
    ...
    public void loadItems() {
        configItem = (new ItemCreator(Material.REDSTONE_COMPARATOR))
                .setName(getMainColor() + "Configurer la partie §e§l▪ §f§lClique droit").setGlow(true);
        teamItem = (new ItemCreator(Material.BANNER)).setName(getMainColor() + "Rejoindre une équipe §e§l▪ §f§lClique droit");
        activeScenario = (new ItemCreator(Material.BOOK)).setName("§6Consultez les Scenario §e§l▪ §f§lClique droit");
        quitItem = (new ItemCreator(Material.BED)).setName("§c§lQuittez la partie §e§l▪ §f§lClique droit");
